...
namespace Leaf.IO
{
    ...
    public class EndianAwareBinaryReader : BinaryReader
    {
        ...
        public EndianAwareBinaryReader(Stream input, bool bigEndian = true)
            : base(input)
        {
        ...
        public EndianAwareBinaryReader(Stream input, Encoding encoding, bool bigEndian = true)
            : base(input, encoding)
        {
            throw new NotImplementedException();
        }
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="input"/> stream or <paramref name="encoding"/> is <c>null</c>.</exception>
        public EndianAwareBinaryReader(Stream input, Encoding encoding, bool leaveOpen, bool bigEndian = true)
